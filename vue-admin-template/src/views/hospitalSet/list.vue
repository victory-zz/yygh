<template>
  <div class="app-container">
      ...
      :data="list" stripe style="width: 100%" @selection-change="handleSelectionChange">
         ...
         <el-table-column prop="contactsName" label="联系人姓名" width="120"/>
         <el-table-column prop="contactsPhone" label="联系人手机" width="120"/>
         ...
         <el-table-column label="操作" width="350" align="center">
            <template slot-scope="scope">
               ...
               <el-button v-if="scope.row.status==0" type="danger" size="mini"
                  icon="el-icon-delete" @click="lockHostSet(scope.row.id,1)">解除</el-button>
   ...
   methods: {//定义方法，进行请求接口调用
      ...
      removeRows() {
         this.$confirm('此操作将永久删除医院的设置信息, 是否继续?', '提示', {
            ...
            //调用接口
           hospitalSetApi.batchRemoveHospSet(idList)
               .then(response => {
                  //提示
                  this.$message({
                     type: 'success',
